...
class Register_page(tk.Frame):
    def __init__(self, parent, controller):
        ...
        self.register_icon_label = tk.Label(self, image=self.load_register_icon, bg="#FDCA40")
        self.register_label = tk.Label(self, text='Registration', font='Bahnschrift 70 bold', bg="#FDCA40")
        ...
        self.return_login = tk.Button(self, image=self.return_img, bg="#FDCA40", bd="3", relief='raised', command=lambda: controller.show_frame("Login"))
        #Backdrop Left
        ...
        self.username_label = tk.Label(self, text='Username', font='Bahnschrift 20 bold', bg='#33A1FD')
        ...
        self.password_label = tk.Label(self, text='Password', font='Bahnschrift 20 bold', bg='#33A1FD')
        self.password_entry = tk.Entry(self, font=('arial', 16), width=24)
        self.password_entry.bind('<FocusIn>', handleFocusIn)
        self.retype_password_label = tk.Label(self, text='Retype Password', font='Bahnschrift 20 bold', bg='#33A1FD')
        self.retype_password_entry = tk.Entry(self, font=('arial', 16), width=24)
        self.retype_password_entry.bind('<FocusIn>', handleFocusIn)
        self.email_label = tk.Label(self, text='Email', font='Bahnschrift 20 bold', bg='#33A1FD')
        self.email_entry = tk.Entry(self, font=('arial', 16), width=24)
        self.fullname_label = tk.Label(self, text='Full Name', font='Bahnschrift 20 bold', bg='#33A1FD')
        self.fullname_entry = tk.Entry(self, font=('arial', 16), width=24)
        self.nationality_label = tk.Label(self, text='Nationality', font='Bahnschrift 20 bold', bg='#33A1FD')
        self.nationality_entry = tk.Entry(self, font=('arial', 16), width=24)
        self.github_label = tk.Label(self, text='Github Username(Optional)', font='Bahnschrift 20 bold', bg='#33A1FD')
        self.github_entry = tk.Entry(self, font=('arial', 16), width=24)
        #Backdrop Middle
        self.backdrop3 = self.backdrop1
        self.backdrop3_label = tk.Label(self, image=self.backdrop1, bg='#2176FF')
        self.LinkedIn_label = tk.Label(self, text='LinkedIn URL (Optional)', font='Bahnschrift 20 bold', bg='#33A1FD')
        self.LinkedIn_entry = tk.Entry(self, font=('arial', 16), width=24)
        self.age_label = tk.Label(self, text='Age', font='Bahnschrift 20 bold', bg='#33A1FD')
        ...
        self.meet_pref_dd.configure(font='Bahnschrift 12 bold', bg='#33A1FD', fg='black', bd=-2)
        ...
        self.locale_pref_dd.configure(font='Bahnschrift 12 bold', bg='#33A1FD', fg='black', bd=-2)
        locale_pref_menu = self.nametowidget(self.locale_pref_dd.menuname)
        locale_pref_menu.configure(font='Bahnschrift 12 bold')
        self.field_label = tk.Label(self, text='Specialization/Field of Study', font='Bahnschrift 20 bold', bg='#33A1FD')
        ...
        self.backdrop2_label = tk.Label(self, image=self.backdrop2, bg='#2176FF')
        var1 = tk.IntVar(self)
        var2 = tk.IntVar(self)
        var3 = tk.IntVar(self)
        var4 = tk.IntVar(self)
        ...
        self.check1 = tk.Checkbutton(self, text='Python', font='Bahnschrift 16 bold', bg='#33A1FD', bd=-2, variable=var1)
        ...
        self.check2 = tk.Checkbutton(self, text='C++', font='Bahnschrift 16 bold', bg='#33A1FD', bd=-2, variable=var2)
        ...
        self.check3 = tk.Checkbutton(self, text='C#', font='Bahnschrift 16 bold', bg='#33A1FD', bd=-2, variable=var3)
        ...
        self.check4 = tk.Checkbutton(self, text='C', font='Bahnschrift 16 bold', bg='#33A1FD', bd=-2, variable=var4)
        ...
        self.check5 = tk.Checkbutton(self, text='Java', font='Bahnschrift 16 bold', bg='#33A1FD', bd=-2, variable=var5)
        ...
        self.check6 = tk.Checkbutton(self, text='Javascript', font='Bahnschrift 16 bold', bg='#33A1FD', bd=-2, variable=var6)
        ...
        self.check7 = tk.Checkbutton(self, text='PHP', font='Bahnschrift 16 bold', bg='#33A1FD', bd=-2, variable=var7)
        ...
        self.check8 = tk.Checkbutton(self, text='SQL', font='Bahnschrift 16 bold', bg='#33A1FD', bd=-2, variable=var8)
        ...
        self.check9 = tk.Checkbutton(self, text='HTML', font='Bahnschrift 16 bold', bg='#33A1FD', bd=-2, variable=var9)
        ...
        self.check10 = tk.Checkbutton(self, text='CSS', font='Bahnschrift 16 bold', bg='#33A1FD', bd=-2, variable=var10)
        ...
        self.next_button = tk.Button(self, text='Continue To Next Step', font='Bahnschrift 20 bold', bg='#FDCA40', bd=3, relief='raised', width=20, height=1, command=goto_cfm_page)
