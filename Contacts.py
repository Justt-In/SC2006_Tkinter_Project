...
class Contacts_page(tk.Frame):
    ...
    def __init__(self, parent, controller):
            ...
            for name in proggies_list:
                ...
                if count == 0:
                    if picture[0][0] != None:
                        ...
                        self.proggy_image1 = ImageTk.PhotoImage(self.load_proggy_image1.resize((100, 100), Image.ANTIALIAS))
                    ...
                    if picture[0][0] != None:
                        ...
                        self.proggy_image2 = ImageTk.PhotoImage(self.load_proggy_image2.resize((100, 100), Image.ANTIALIAS))
                    ...
                    if picture[0][0] != None:
                        ...
                        self.proggy_image3 = ImageTk.PhotoImage(self.load_proggy_image3.resize((100, 100), Image.ANTIALIAS))
                    ...
                    if picture[0][0] != None:
                        ...
                        self.proggy_image4 = ImageTk.PhotoImage(self.load_proggy_image4.resize((100, 100), Image.ANTIALIAS))
                    ...
                    if picture[0][0] != None:
                        ...
                        self.proggy_image5 = ImageTk.PhotoImage(self.load_proggy_image5.resize((100, 100), Image.ANTIALIAS))
                    ...
                    if picture[0][0] != None:
                        ...
                        self.proggy_image6 = ImageTk.PhotoImage(self.load_proggy_image6.resize((100, 100), Image.ANTIALIAS))
                    ...
                    if picture[0][0] != None:
                        ...
                        self.proggy_image7 = ImageTk.PhotoImage(self.load_proggy_image7.resize((100, 100), Image.ANTIALIAS))
                    ...
                    if picture[0][0] != None:
                        ...
                        self.proggy_image8 = ImageTk.PhotoImage(self.load_proggy_image8.resize((100, 100), Image.ANTIALIAS))
        ...
        self.username_label1 = tk.Label(self, text='Username', bg='#119975', font='Bahnschrift 24 underline bold')
        ...
        self.username_label2 = tk.Label(self, text='Username', bg='#119975', font='Bahnschrift 24 underline bold')
        ...
        self.username_label3 = tk.Label(self, text='Username', bg='#119975', font='Bahnschrift 24 underline bold')
        ...
        self.username_label4 = tk.Label(self, text='Username', bg='#119975', font='Bahnschrift 24 underline bold')
        ...
        self.username_label5 = tk.Label(self, text='Username', bg='#119975', font='Bahnschrift 24 underline bold')
        ...
        self.username_label6 = tk.Label(self, text='Username', bg='#119975', font='Bahnschrift 24 underline bold')
        ...
        self.username_label7 = tk.Label(self, text='Username', bg='#119975', font='Bahnschrift 24 underline bold')
        ...
        self.username_label8 = tk.Label(self, text='Username', bg='#119975', font='Bahnschrift 24 underline bold')
